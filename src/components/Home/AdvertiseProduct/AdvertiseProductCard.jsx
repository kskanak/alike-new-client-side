...
const AdvertiseProductCard = ({ product }) => {
  console.log(product);
  const { img, name, orginal_price, price, catagory } = product;
  return (
    <div>
      <div className=" rounded-lg shadow-lg bg-gray-900 text-gray-100 border">
        ...
        <div className="flex flex-col justify-between p-6 space-y-8">
          <div className="space-y-2">
            ...
            <p className="dark:text-gray-100"> Brand : {catagory}</p>
            <p className="dark:text-gray-100">Selling Price : {price}</p>
